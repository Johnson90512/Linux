...
cmd = os.system("git clone https://github.com/rebootuser/LinEnum ~/scripts/linenum")
cmd = os.system("git clone https://github.com/DominicBreuker/pspy ~/scripts/pspy")
cmd = os.system("git clone https://github.com/danielmiessler/SecLists /opt/seclists")
