...
cmd = os.system("git clone https://github.com/rebootuser/LinEnum.git ~/scripts")
cmd = os.system("git clone https://github.com/DominicBreuker/pspy.git ~/scripts")
cmd = os.system("git clone https://github.com/danielmiessler/SecLists.git /opt/")
